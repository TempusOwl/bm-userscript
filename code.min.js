...
new MutationObserver((e,t)=>{for(var o of e)if("childList"===o.type||"attributes"===o.type){var o=document.querySelector(".ReactVirtualized__Grid__innerScrollContainer"),r=document.querySelector(".navbar-brand");
// If either class exists, start the code and disconnect the observer
if(o||r){console.log("Target element detected. Starting code..."),t.disconnect(),// Stop observing after the first detection
runCode();// Start the main logic
break}}}).observe(document.body,{childList:!0,// Detect when nodes are added or removed
subtree:!0,// Look within the entire document
attributes:!0})}
