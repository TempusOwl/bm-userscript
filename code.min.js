...
id:e,
value:t,
style:`width: 35px; margin-right: 5px; padding: 2px; font-size: 8pt; background: ${r};`,
onclick:(
...
".ReactVirtualized__Grid__innerScrollContainerddd"
)||document.querySelector(
".css-b7r34x"
)
){
...
i.forEach(
e=>{
e.style.color=colors.cNoteColorIcon
}
)
,
document.querySelector(
...
"CBL script already in progress... Skipping..."
);else{
var e=o(
"765"
,
...
,
console.log(
`CBL API Query ${t}: Fetching user data for SteamID `+r
)
var n=await fetch(
c
,
...
`HTTP error! Status: ${n.status} (${n.statusText})`
)
var a=await n.json(
)
if(
!a||!a.data||!a.data.steamUser
)throw new Error(
"Invalid response format or user not found."
)
var s=a.data.steamUser
,
i=s.riskRating||"NA"
,
l=s.activeBans.edges.length||0
,
d=s.expiredBans.edges.length||0
u(
i
,
l
...
console.error(
"Max retries reached. Fetch operation failed."
)
,
u(
"NA"
...
return void await void 0
}
}catch(
e
){
console.error(
"Error fetching Steam user data:"
,
e
)
}finally{
...
e.id="copy-button"
,
e.textContent="Copy Player Info"
,
e.classList.add(
"copy-button-style"
)
...
t.id="open-url-button"
,
t.textContent="Open CBL"
,
t.classList.add(
...
e&&"SteamID MISSING?"!==e?window.open(
""
,
"_blank"
):alert(
"SteamID is missing or invalid!"
)
}
)
,
...
"childList"===o.type||"attributes"===o.type
){
...
console.log(
"Target element detected. Starting code..."
)
,
t.disconnect(
)
