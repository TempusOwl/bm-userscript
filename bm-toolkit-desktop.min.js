...
,
o.href="https://communitybanlist.com/search/"+t
,
o.innerHTML=t
,
o.target="_blank"
...
var e=getInnerTextByTitle(
"765"
,
"SteamID MISSING?"
)
,
t=getInnerTextByTitle(
"0002"
,
""
)
...
"#RCONPlayerPage > h1"
)?.innerText||"NAME MISSING?"} <${window.location.href}>
**IDs**: ${e} // ${t}
**Server**:
**Infraction**:
...
,
// Avoids scrolling to the bottom
t.style.opacity="0"
,
// Hides the element
t.value=e
...
s.style="position: absolute; top: 10px; right: 5%; z-index: 99999;"
,
document.body.appendChild(
s
)
